    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg
          ...
          > */}
          <p
            className={`${zenmarugothic.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}
          >
          ...
          <Link
            ...
            className="flex items-center gap-5 self-start rounded-lg
                      bg-fuchsia-500 px-6 py-3 text-sm font-medium text-white transition-colors 
                      hover:bg-blue-400 
                      md:text-base"
          >
